...
name: tailwind
description: >-
  Tailwind v4 browser-runtime patterns for HyperFrames video compositions with
  deterministic rendering. Use when working on HyperFrames compositions with
  init --tailwind, window.__tailwindReady, @theme/@utility blocks, or missing
  Tailwind styles during render.
---
